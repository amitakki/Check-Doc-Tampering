...
def index():
    ...
    # Execute if the request is post
    if request.method == "POST":
        ...
        # Resize and save original image to ensure both uploaded and original have same size
        ...
        # Read uploaded and original images as an array
